...
class AddHosts:
    ...
    def appendHostPostgreSQL(self, host, port, username, password, dirs):
        self.addPostgreSQL("INSERT INTO public.\"{0}\" (ip_address, port_opened, user_name, pass, dirs) VALUES ('{1}', '{2}', '{3}', '{4}', '{5}'); commit;"
                           .format('ReadyToScan', host, port, username, password, dirs))
