...
class AddHosts:
    ...
    def allHostsPostgreSQL(self):
        currentHostsServer = self.requestPostgreSQL("SELECT ip_address FROM public.\"{0}\";".format('ReadyToScan'))

        return currentHostsServer

    def appendHostPostgreSQL(self, appendData):
        self.addPostgreSQL("INSERT INTO public.\"{0}\" (ip_address, port_opened) VALUES ('{1}', '{2}'); commit;"
                           .format('ReadyToScan', appendData[1], appendData[0]))
