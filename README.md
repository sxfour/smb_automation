...
Этапы работы: 
1. Диалекты и график vers( 1 поток ). 
...
Как видите при успешном connect, нам возвращается vers диалекта (числовой формат) Если видимый протокол, возвращает Not supported, начинается перебор всех vers.
...
Тут видны все vers диалектов, количество активных хостов с vers smb. В зависимости от блоков адресов, диалекты заметно меняются. Это может быть вaжным при создание mass scan
